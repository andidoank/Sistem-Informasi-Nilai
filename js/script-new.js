/*Versió modificada per David Figueres
##Permet passar un 4rt paràmetre al constructor que serà una funció que s'activarà sempre que es modifiqui l'estructura de la taula.
##Això ha sortit d'un error detectat a través de l'ús de TinyTable i jquery.ContextMenu
*/
var TINY={};
...
TINY.table=function(){
	...
	sorter.prototype.init=function(){
		...
		if(this.p.colddid){
			d=T$(this.p.colddid);
			var o=document.createElement('option'); o.value=-1; o.innerHTML='Global search'; d.appendChild(o)
		}
		for(i;i<t.w;i++){
